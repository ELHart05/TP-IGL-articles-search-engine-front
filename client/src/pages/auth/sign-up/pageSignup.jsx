    ...
    return(
        <div className="flex bg-[#F9F9F9] text-black min-h-screen">
            <div className="hidden sm:block w-full h-full">
                <img src={article} alt="articles" className="h-full" />
            </div>
            <div className="flex flex-col items-center w-full mt-8 px-6">
                ...
                <form className="flex flex-col justify-center items-center w-full gap-12">
                    ...
                    <div className="flex flex-col items-center w-full py-24 gap-7">
                        <button className="w-full bg-[#004D40] hover:bg-[#004D40]/[0.8] transition-colors duration-[0.5s] py-5 rounded-3xl text-white text-[20px]">Sign Up</button>
                        <p className="text-[#800020]">
                            Already have an account ?
                            <a href="/auth/sign-in" className="hover:underline ml-1">Signin</a>
                        </p>
                    </div>
                </form>
            </div>
