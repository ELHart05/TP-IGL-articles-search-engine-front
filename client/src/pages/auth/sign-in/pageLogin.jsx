    ...
    return(
        <div className="flex bg-[#F9F9F9] text-black">
                ...
                <div className="flex flex-col items-center w-full mt-24 px-6">
                    ...
                    <form className="flex flex-col justify-center items-center w-full gap-16">
                        ...
                        <div className="flex flex-col items-center w-full py-19 gap-7">
                            <button className="w-full bg-[#004D40] hover:bg-[#004D40]/[0.8] transition-colors duration-[0.5s] py-5 rounded-3xl text-white text-[20px]">SignIn</button>
